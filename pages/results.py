...
from streamlit_card import card  # for card UI
import plotly.express as px

# --- Sidebar: Google Service Account Login ---
st.sidebar.header("🔑 Login with Google Service Account")
service_file = st.sidebar.file_uploader("Upload Google Service Account JSON", type=["json"])
...
if service_file:
    ...
    if "Amount" in df.columns and "Category" in df.columns:
        fig = px.bar(df, x="Category", y="Amount", color="Status", barmode="group", title="Amount by Category and Status")
